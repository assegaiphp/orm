...
interface RepositoryInterface
{
   ...
   *
   * @param FindOptions|array{select: array|null|object, relations: array|null|object, where: array|FindWhereOptions|null, order: array|null|object, skip: int|null, limit: int|null, exclude: array|string[], hydrate?: bool, with_real_total: bool}|null $findOptions The options to find entities.
   ...
   *
   * @param FindWhereOptions|array{conditions?: array<string, mixed>, exclude?: string[], hydrate?: bool, with_real_total?: bool} $where The options to find entities.
   * @return FindResult<T> Returns an instance of `FindResult` which contains a list of entities that match the
