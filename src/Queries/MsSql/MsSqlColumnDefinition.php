...
/**
 * MSSQL-specific column-definition builder.
 */
class MsSqlColumnDefinition extends SQLColumnDefinition
{
  /**
   * Build the SQL Server-flavored column definition.
   *
   * @return string Returns the rendered SQL Server column definition.
   */
  protected function buildDefinition(): string
  {
    return $this->buildMsSqlDefinition();
  }

  /**
   * Resolve the SQL Server-specific type expression.
   *
   * @return string Returns the SQL Server type expression.
   */
  protected function resolveTypeExpression(): string
  {
    return $this->getMsSqlType();
  }

  /**
   * Create a SQL Server column-definition builder.
   *
