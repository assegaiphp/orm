...
/**
 * MariaDB-specific column-definition builder.
 */
class MariaDbColumnDefinition extends SQLColumnDefinition
{
  /**
   * Builds the MariaDB-flavored column definition.
   *
   * @return string Returns the rendered MariaDB column definition.
   */
  ...
  /**
   * Create a MariaDB column-definition builder.
   *
