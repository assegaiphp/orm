...
/**
 * MySQL-owned sort-key builder.
 */
final class MySQLKeyPart extends SQLKeyPart
{
  /**
   * Creates a MySQL sort-key builder.
   *
  ...
  {
    parent::__construct(key: $key, ascending: $ascending, dialect: SQLDialect::MYSQL);
  }
}
