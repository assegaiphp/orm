...
/**
 * MySQL-specific column-definition builder.
 */
class MySQLColumnDefinition extends SQLColumnDefinition
{
  /**
   * Builds the MySQL-flavored column definition.
   *
   * @return string Returns the rendered MySQL column definition.
   */
  ...
  /**
   * Create a MySQL column-definition builder.
   *
